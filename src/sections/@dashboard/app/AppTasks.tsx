...
export default function AppTasks({ title, subheader, list, ...other }:PropTypes.InferProps<typeof AppTasks.propTypes>) {
...
function TaskItem({ task, checked, onChange }:PropTypes.InferProps<typeof TaskItem.propTypes>) {
